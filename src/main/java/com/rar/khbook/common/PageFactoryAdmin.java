...
public class PageFactoryAdmin {
	...
	//판매내역 검색 페이지바	
	public static String getPageBar14(int totalData, 
			int cPage, int numPerpage, String url) {
		...
		if(pageNo==1) { 
			...
			pageBar+="<li class='pageBar_li'>";
			pageBar+="<a class='' href='javascript:searchSale("
			+(pageNo-1)+",10)'>이전</a>";
			pageBar+="</li>";
		}
	...
	// 판매내역 정렬 페이지바
	public static String getPageBar15(int totalData, 
			int cPage, int numPerpage, String url) {
		...
		if(pageNo==1) { 
			...
			pageBar+="<li class='pageBar_li'>";
			pageBar+="<a class='' href='javascript:orderSaleList("
			+(pageNo-1)+",10)'>이전</a>";
			pageBar+="</li>";
		}
