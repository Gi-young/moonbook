...
public class PageFactory {
	...
	public static String getUsedboardPageBar(int totalData, int cPage, int numPerpage, String url) {
		...
		pageBar += "<script>";
		pageBar += "function fn_paging(cPage){";
		pageBar += "location.assign('" + url + "?cPage='+cPage+'&dataVolume='+dataVolume);}";
		pageBar += "</script>";

		return pageBar;
	}

	public static String getWonJaePageBar(int totalData, int cPage, int numPerpage) {
		...
		if (pageNo == 1) {
			...
			pageBar += "<li class='page-item'>";
			pageBar += "<a class='page-link' href='javascript:getTrs(" + (pageNo - 1) + ")'>이전</a>";
			pageBar += "</li>";
		}
		...
		while (!(pageNo > pageEnd || pageNo > totalPage)) {
			if (pageNo == cPage) {
				...
				pageBar += "<a class='page-link' href='javascript:getTrs(" + (pageNo) + ")'>" + pageNo + "</a>";
		...
		if (pageNo > totalPage) {
			...
			pageBar += "<li class='page-item'>";
			pageBar += "<a class='page-link' href='javascript:getTrs(" + (pageNo) + ")'>다음</a>";
			pageBar += "</li>";
		}
