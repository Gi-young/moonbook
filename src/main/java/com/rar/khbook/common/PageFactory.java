...
public class PageFactory {
	...
	public static String getOwnPageBarAjax(int totalData, int cPage, int numPerpage, String url, int flag) {
		...
		if (pageNo == 1) {
			...
			if(flag==0) {
				...
				pageBar += "<a class='' href='javascript:fn_paging2(" + (pageNo - 1) + ")'>이전</a>";
			}else {
				pageBar += "<a class='' href='javascript:fn_paging3(" + (pageNo - 1) + ")'>이전</a>";				
			}
			pageBar += "</li>";
		}
		...
		while (!(pageNo > pageEnd || pageNo > totalPage)) {
			if (pageNo == cPage) {
				...
				if(flag==0) {
					...
					pageBar += "<a class='' href='javascript:fn_paging2(" + (pageNo) + ")'>" + pageNo + "</a>";
				}else {
					pageBar += "<a class='' href='javascript:fn_paging3(" + (pageNo) + ")'>" + pageNo + "</a>";					
				}
		...
		if (pageNo > totalPage) {
			...
			if(flag == 0) {
				...
				pageBar += "<a class='' href='javascript:fn_paging2(" + (pageNo) + ")'>다음</a>";
			}else {
				pageBar += "<a class='' href='javascript:fn_paging3(" + (pageNo) + ")'>다음</a>";				
			}
			pageBar += "</li>";
		}
