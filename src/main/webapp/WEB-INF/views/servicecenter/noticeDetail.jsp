		...
		<div class="service-box2" style="border:none;">
          ...
          <div class="service-box2">
           <table class="review-exp review-board" id="targetTable" style="width:770px;">
	            <tr>
	            <th style='width:70px;'>${notice.noticeboardNo}</th>
	            <th style='width:480px;'>${notice.noticeboardTitle}</th>
	            <th style='width:110px;'>${notice.memberId}</th>
	            <th style='width:110px;'>${notice.noticeboardDate}</th>
	            </tr>
            <tr class='review-text review-tr'>
	         <td>내용</td>
	         <td colspan="3">
	         <p>
	           	${notice.noticeboardContent }
	         </p>
	         </td>
	   	    </tr>
           </table>	
		<div style="display:flex; justify-content:center; align-items:center; ">	
			<a href="javascript:history.back()"><img id="backImg" src="${path }/resources/img/sellLev1/back3.png" alt="문곰도서" style="opacity:0.5;"></a>
		</div>
        <div id="pageBar"></div> 
		</div>
		</div>
