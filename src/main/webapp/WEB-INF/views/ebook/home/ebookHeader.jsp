		...
		<div class="wrapper">
			...
			<nav class="portal-navbar">
				<div class="portal-boundary-box">
					<ul class="portal">
						<li onclick="location.assign('${path}/')">홈</li>
						<li onclick="location.assign('${path}/sellbookController/sellbook.do')">도서</li>
						<li onclick="location.assign('${path}/gift/giftView.do')">기프트</li>
						<li onclick="location.assign('${path}/usedboard/usedboardList.do')">중고</li>
						<li onclick="location.assign('${path}/auction/auction')">경매</li>
					</ul>
					...
					<ul class="management">
						...
						<li onclick="location.assign('${path}/service/serviceMain.do')">고객센터</li>
					</ul>
				</div>
			</nav>
