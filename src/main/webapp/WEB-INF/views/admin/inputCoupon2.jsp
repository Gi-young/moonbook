...
<link rel="stylesheet" href="${path}/resources/css/admin/inputCoupon2.css">
			...
			<div class="addProduct-container3">
				<form action="${path}/admin/inputCouponAdminOne.do" method="post" id="couponOne">
					...
					<tr>
							<th>회원 아이디</th>
							<td>
								<input type="text" name="couponMemberId" class="couponInputId" required><span class="colorChange"></span>
							</td>
						</tr>
						<tr>
							<th>발급할 쿠폰 종류</th>
						...
						<tr>
							<td colspan="2">
								<input type="submit" id="submitBtn" value="발급" onclick="return checkCouponNum(event);" class="adminBtn">
							</td>
						</tr>
					</table>
				</form>	
