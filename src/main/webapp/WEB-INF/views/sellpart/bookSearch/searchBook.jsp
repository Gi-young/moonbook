...
<jsp:include page="/WEB-INF/views/sellpart/stickymenu/stickybook.jsp">
	...
	<link rel="stylesheet" type="text/css" href="${path}/resources/css/sellpart/searchBook.css">
			...
			<div class="search-box">
				<form id="searchFrm" action="${path}/ebook/search.do">
					...
					<div class="searchBar">
						...
						<select id="category" name="categoryCode"></select>
	...
	<script src="${path}/resources/js/sellpart/bookSearch/searchBook.js"></script>
