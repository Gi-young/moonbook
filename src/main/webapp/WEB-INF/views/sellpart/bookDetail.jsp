						...
						<div id="content_middle" style="display: flex;">
							...
							<div class="bookView_order" style="margin-left: 50px;">
								...
								<div><br><br>
									...
									<p>판매가 : <span style="font-size: 18px; color: red;">
											<fmt:formatNumber value="${book.price*0.9 }" type="currency" />
										</span> <span>할인율: [ <span>10%</span> ] </span></p><br><br>
								</div>
								<div><br><br>
								...
								<div><br><br>
									...
									<input type="number" id="stock" name="stock" value="${book.stock }"
										readonly><br><br>
									<span>&nbsp;&nbsp;&nbsp;&nbsp;주문수량&nbsp;&nbsp;</span>
									<input type="number" id="sellStock" name="shopingListCount"
										value="1"><br><br><br><br>
								</div>
								<div
						...
						<div class="product-review">
							<div class="writeBox">
								<button class="reviewWrite"
									onclick="window.open('<%=request.getContextPath()%>/SellbookController/insertReview.do?bindNo=${book.bindNo }&loginMember=${loginMember.memberId }', '리뷰를 남겨주세요!', 'width=500, height=600')">상품
									리뷰 작성하기</button>
							</div>
