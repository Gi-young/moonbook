		...
		<form id="searchFrm">
			<div>
				...
				<select id="categoryCode" name="categoryCode">
					<option value="320010010">초등 동화(1~2학년)</option>
					<option value="320020010">초등 동화(3~4학년)</option>
					<option value="320030010">초등 동화(5~6학년)</option>
					<option value="320040010" selected>초등 동화(공통)</option>
				</select>
